...
import 'package:student_app/core/common/widget/bottomSheets/unsaved_item_sheet_content.dart';
...
class _SavedItemsScreenState extends State<SavedItemsScreen>
  ...
  final List<String> _tabs = <String>['فيديوهات', 'مكثفات'];
                ...
                return Container(
                  ...
                  child: Dismissible(
                    ...
                    onDismissed: (_) {
                      unsavedBottomSheet(
                        context,
                        "هل تريد إزالة الفيديو من العناصر المحفوظة ؟",
                      );
                    },
