...
@RoutePage()
class QuestionResponseScreen extends StatefulWidget {
  const QuestionResponseScreen({super.key});

  @override
  _QuestionResponseScreenState createState() => _QuestionResponseScreenState();
}

class _QuestionResponseScreenState extends State<QuestionResponseScreen>
                ...
                return Container(
                  ...
                  child: Dismissible(
                    ...
                    child: PartWidget(
                      ...
                      onTogglePart: () {
                        context.router.push(
                          const QuestionResponseResponseRoute(),
                        );
                      },
